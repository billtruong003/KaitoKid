...
namespace Fusion.XR.Shared.Core
{
    public class HardwareControllerCommand : MonoBehaviour, IHandCommandProvider
    {
        ...
        IGrabbingProvider grabbingProvider;
        ...
        protected virtual void Awake()
        {
            ...
            grabbingProvider = hardwareController.gameObject.GetComponent<IGrabbingProvider>();
        ...
        private void Update()
        {
            ...
            if (updateHandCommandWithAction)
            {
                ...
                _handCommand.gripCommand = grabbingProvider != null && grabbingProvider.IsGrabbing ? 1 : gripAction.action.ReadValue<float>();
