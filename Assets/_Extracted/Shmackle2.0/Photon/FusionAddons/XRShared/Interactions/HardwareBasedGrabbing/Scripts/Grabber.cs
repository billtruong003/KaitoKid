...
namespace Fusion.XR.Shared.Core.HardwareBasedGrabbing {
    ...
    public class Grabber : MonoBehaviour
    {
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (grabbable != null)
            {
                bool isRegrabbing = lastUngrabbedObject == grabbable;
        ...
        public virtual void Ungrab(Grabbable grabbable)
        {
            ...
            // Last grabbed object should not be grabbed again on the same frame
            lastUngrabbedObject = grabbedObject;
