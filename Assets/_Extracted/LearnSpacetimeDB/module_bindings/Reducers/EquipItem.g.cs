...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void EquipItemHandler(ReducerEventContext ctx, uint slotId);
        public event EquipItemHandler? OnEquipItem;

        public void EquipItem(uint slotId)
        {
            conn.InternalCallReducer(new Reducer.EquipItem(slotId));
        }
