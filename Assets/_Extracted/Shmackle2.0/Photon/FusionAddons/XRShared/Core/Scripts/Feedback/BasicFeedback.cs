...
namespace Fusion.XR.Shared.Core
{
    ...
    public class BasicFeedback : MonoBehaviour, IFeedbackHandler
    {
        ...
        public void PlayAudioAndHapticFeeback(string audioType = null, float hapticAmplitude = -1, float hapticDuration = -1, IHapticFeedbackProviderRigPart hardwareRigPart = null, FeedbackMode feedbackMode = FeedbackMode.AudioAndHaptic, bool audioOverwrite = true)
        {
