    ...
    public class Grenade : MonoBehaviour {
        ...
        void OnGrenadeRelease(Hand hand, Grabbable grab) {
            ...
            if(grenade != null && startDelayOnRelease)
                Invoke(nameof(CheckJointBreak), explosionDelay + Time.fixedDeltaTime * 3);
        ...
        void Explode() {
            ...
            var exp =    GameObject.Instantiate(explosionEffect, grenade.transform.position, grenade.transform.rotation);
