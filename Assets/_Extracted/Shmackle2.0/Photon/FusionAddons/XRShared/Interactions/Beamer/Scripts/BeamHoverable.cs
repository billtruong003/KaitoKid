    ...
    public class BeamHoverable : MonoBehaviour, IBeamHoverListener
    {
        ...
        public void OnHoverStart(BeamHoverer beamHoverer)
        {
            ...
            if (feedback != null && feedback.IsAudioFeedbackIsPlaying() == false)
                feedback.PlayAudioAndHapticFeeback(audioType: audioFeedbackType, hardwareRigPart: beamHoverer.hapticFeedbackProvider, feedbackMode: FeedbackMode.AudioAndHaptic, audioOverwrite: false);
        }
