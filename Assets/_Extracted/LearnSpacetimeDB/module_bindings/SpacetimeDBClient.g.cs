...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        public RemoteTables(DbConnection conn)
        {
            ...
            AddTable(MobDef = new(conn));
            AddTable(MobInstance = new(conn));
            AddTable(Player = new(conn));
            AddTable(PlayerAppearance = new(conn));
            AddTable(PlayerPosition = new(conn));
            AddTable(PlayerStats = new(conn));
            AddTable(SpawnConfig = new(conn));
        }
    }
    ...
    public sealed class QueryBuilder
    {
        ...
        internal static string[] AllTablesSqlQueries() => new string[]
        {
            ...
            new QueryBuilder().From.MobDef().ToSql(),
            new QueryBuilder().From.MobInstance().ToSql(),
            new QueryBuilder().From.Player().ToSql(),
            new QueryBuilder().From.PlayerAppearance().ToSql(),
            new QueryBuilder().From.PlayerPosition().ToSql(),
            new QueryBuilder().From.PlayerStats().ToSql(),
            new QueryBuilder().From.SpawnConfig().ToSql(),
        }
        ;
    }
    ...
    public sealed class From
    {
        ...
        public global::SpacetimeDB.Table<MobDef, MobDefCols, MobDefIxCols> MobDef() => new("mob_def", new MobDefCols("mob_def"), new MobDefIxCols("mob_def"));
        public global::SpacetimeDB.Table<MobInstance, MobInstanceCols, MobInstanceIxCols> MobInstance() => new("mob_instance", new MobInstanceCols("mob_instance"), new MobInstanceIxCols("mob_instance"));
        ...
        public global::SpacetimeDB.Table<PlayerAppearance, PlayerAppearanceCols, PlayerAppearanceIxCols> PlayerAppearance() => new("player_appearance", new PlayerAppearanceCols("player_appearance"), new PlayerAppearanceIxCols("player_appearance"));
        ...
        public global::SpacetimeDB.Table<SpawnConfig, SpawnConfigCols, SpawnConfigIxCols> SpawnConfig() => new("spawn_config", new SpawnConfigCols("spawn_config"), new SpawnConfigIxCols("spawn_config"));
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.AdminGiveItem args => Reducers.InvokeAdminGiveItem(eventContext, args),
                Reducer.AdminHealAllPlayers args => Reducers.InvokeAdminHealAllPlayers(eventContext, args),
                Reducer.AdminKillAllMobs args => Reducers.InvokeAdminKillAllMobs(eventContext, args),
                Reducer.AdminSetStats args => Reducers.InvokeAdminSetStats(eventContext, args),
                Reducer.AdminSpawnMob args => Reducers.InvokeAdminSpawnMob(eventContext, args),
                Reducer.AdminSpawnRandomWave args => Reducers.InvokeAdminSpawnRandomWave(eventContext, args),
                Reducer.AdminTeleport args => Reducers.InvokeAdminTeleport(eventContext, args),
                Reducer.AdminToggleSpawnConfig args => Reducers.InvokeAdminToggleSpawnConfig(eventContext, args),
                Reducer.AttackMob args => Reducers.InvokeAttackMob(eventContext, args),
                Reducer.AttackPlayer args => Reducers.InvokeAttackPlayer(eventContext, args),
                ...
                Reducer.PickupLoot args => Reducers.InvokePickupLoot(eventContext, args),
                Reducer.SendChat args => Reducers.InvokeSendChat(eventContext, args),
                Reducer.SpawnMob args => Reducers.InvokeSpawnMob(eventContext, args),
                Reducer.UnequipItem args => Reducers.InvokeUnequipItem(eventContext, args),
                Reducer.UpdateMovement args => Reducers.InvokeUpdateMovement(eventContext, args),
                Reducer.UseSkill args => Reducers.InvokeUseSkill(eventContext, args),
