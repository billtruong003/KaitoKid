namespace Fusion.XR.Shared.Core
{
    ...
    {
        public void PlayAudioAndHapticFeeback(string audioType = null, float hapticAmplitude = USE_DEFAULT_VALUES, float hapticDuration = USE_DEFAULT_VALUES, IHapticFeedbackProviderRigPart hardwareRigPart = null, FeedbackMode feedbackMode = FeedbackMode.AudioAndHaptic, bool audioOverwrite = true);

        public void StopAudioAndHapticFeeback(IHapticFeedbackProviderRigPart hardwareRigPart = null);
