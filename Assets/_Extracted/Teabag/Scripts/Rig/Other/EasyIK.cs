...
{
    [Header("Quality")]
    public int closeIterations = 10;
    public float closeTolerance = 0.01f;
    public int distantIterations = 1;
    public float distantTolerance = 0.1f;
    ...
    public float distance
    {
        get
        {
            ...
            if (localRig == null) return 1f;
            Vector3 position = localRig.Headset.Position;
    ...
    public int iterations
    {
        get
        {
            return Mathf.RoundToInt(Mathf.Lerp(closeIterations, distantIterations, distance));
        }
    }
    public float tolerance
    {
        get
        {
            return Mathf.Lerp(closeTolerance, distantTolerance, distance);
        }
    }
    ...
    private void SolveIK()
    {
        ...
        jointTransforms[jointTransforms.Length - 1].rotation = ikTarget.rotation * offset;
    }
    ...
    void LateUpdate()
    {
        // Re-solve after Player.LateUpdate() applies vehicle delta correction.
        // Without this, IK targets are 1 frame behind when on a moving vehicle.
        SolveIK();
    }
