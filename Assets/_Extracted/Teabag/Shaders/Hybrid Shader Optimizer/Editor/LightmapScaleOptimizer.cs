...
namespace TechArt.Tools
{
    public class LightmapScaleOptimizer : EditorWindow
    {
        ...
        private class ObjectEntry
        {
            ...
            public float estimatedTexels;
            public float texelPercentOfAtlas;

            public bool selected = false;
            public bool shouldDisableGI = false;
        }
        ...
        private float _lightmapResolution = 15f;
