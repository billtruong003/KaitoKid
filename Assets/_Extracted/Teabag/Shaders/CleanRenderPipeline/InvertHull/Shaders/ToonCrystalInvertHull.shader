Shader "CleanRender/ToonCrystal InvertHull"
{
    Properties
    {
        [Header(Surface)]
        ...
        _OutlineColor("Outline Color", Color) = (0.05, 0.1, 0.3, 1)
        _OutlineWidth("Outline Width (pixels)", Range(0.1, 10.0)) = 1.2
    ...
    SubShader
    {
        ...
        // ============================================================
        // Pass 1: ForwardLit (Crystal shading)
        // ============================================================
        Pass
        {
            Name "ForwardLit"
