    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings CrystalVert(Attributes input)
            {
                ...
                // Tangent-space view dir for interior parallax
            ...
            half4 CrystalFrag(Varyings input) : SV_Target
            {
                ...
                // ── Fake interior (parallax offset into interior texture) ──
